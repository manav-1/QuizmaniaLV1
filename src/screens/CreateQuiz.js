...
export default function CreateQuiz({ navigation }) {
  ...
  function fetchAvailableQuizTypes() {
    ...
    quizTypesDbRef
      ...
      .catch((error) => {
        displaySnackBar("error", "Failed to get the Users Quiz");
      });
  }
      ...
      {isLoading ? (
        ...
        <ScrollView style={styles.container}>
          <View style={styles.form}>
            ...
            <BasicButton text="Pick Image" onPress={handlePickImgBtnClick} />
            <View style={styles.divider}></View>
            ...
            <BasicButton text="Create" onPress={handleCreateBtnClick} />
            <View style={styles.divider}></View>
          </View>
        </ScrollView>
      )}
